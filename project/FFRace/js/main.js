...
main.onmousemove = function(ev) {
    ...
    // ourPlane.centerX = ev.clientX - box.offsetRight-10;
    ...
    ourPlane.imgNode.style.left = ourPlane.currentX-20 + 'px';
    // ourPlane.imgNode.style.right =-50+'px'
